                ...
                @foreach($store->storeUnits as $storeUnit)
                 <div class="row">
                    <div class="col-md-12">
                	    ...
                	    {{ Form::number('quantity[]', $store->name."/".$storeUnit->name, $errors, $unitProduct,  ['required' => true, 'value' => ($unitProduct && $unitProduct->quantity) ? $unitProduct->quantity : 0, 'class'=>'store-unit-quantity'] ) }}
